...
public class RunAnalyzeCardsInSet {
	...
	public static void run(AnalyzeCardsInSet mainObj, SQLiteConnection db) throws SQLException, IOException {
		...
		if (setName == null || setName.isBlank()) {
			setName = "HAC1;BLVO;SDFC;MAMA;SGX2;SDCB;MP22;TAMA;POTE;" + "LDS3;LED9;DIFO;GFP2;SDAZ;SGX1;BACH;GRCR;BROL;" +
					"MGED;BODE;LED8;SDCS;MP21;DAMA;KICO;EGO1;EGS1;" + "LIOV;ANGU;GEIM;SBCB;SDCH;PHHY;DABL;AMDE;PHHY;MAZE;CYAC;WISU";

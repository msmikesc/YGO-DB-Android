...
class ViewCardSetCardSearchBarChangedListener extends TextChangedListener<EditText> {
    ...
    public ViewCardSetCardSearchBarChangedListener(EditText searchBar, ViewCardSetViewModel viewCardsViewModel, SingleCardToListAdapter adapter, LinearLayoutManager layout) {
        super(searchBar);

...
class ViewSoldCardsSortButtonOnClickListener implements View.OnClickListener {
    ...
    public ViewSoldCardsSortButtonOnClickListener(FloatingActionButton fab, Context context,
                ...
                Executors.newSingleThreadExecutor().execute(() -> {
                    try {
                        ...
                        List<OwnedCard> moreCards =
                                viewSoldCardsViewModel.loadMoreData(finalSortOrder,
                                        ViewSoldCardsViewModel.LOADING_LIMIT,
                                        0, viewSoldCardsViewModel.getCardNameSearch());

...
class ViewSoldCardsEndlessScrollListener extends EndlessScrollListener {
    ...
    public ViewSoldCardsEndlessScrollListener(LinearLayoutManager linearLayoutManager, ViewSoldCardsViewModel viewSoldCardsViewModel, SingleCardToListAdapter adapter) {
